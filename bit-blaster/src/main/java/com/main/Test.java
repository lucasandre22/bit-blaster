...
public class Test {
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            final GamePane gamePane = new GamePane();
            final JSlider slider = new JSlider(25, 10000);
            add(gamePane);
    ...
    public class GamePane extends JPanel {
        ...
        public GamePane() {
            poolOfEntities = new ArrayList<MovableEntity>(25);
            activeEntities = new ArrayList<MovableEntity>(25);
